    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <div style="position: relative; width: 100%; " x-data="{ showPassword:false }">
                <x-text-input id="password"   type="password"  name="password" required autocomplete="current-password" x-bind:type="showPassword ? 'text' : 'password' "/>
        ...
        <div class="flex flex-col items-center justify-end gap-3 mt-4">
            ...
            <a class="text-indigo-400 transition hover:text-indigo-300" href="{{ route('register') }}">
